...
var SessionizeService_1 = __webpack_require__(35);
var dayjs = __webpack_require__(10);
var ScheduleSession_1 = __webpack_require__(32);
var SessionModal_1 = __webpack_require__(33);
var Schedule = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        schedule = _a.sent();
                        return [4 /*yield*/, sessionizeService.GetSpeakers()];
                    case 3:
                        speakers = _a.sent();
    ...
    Schedule.prototype.closeModal = function () {
        this.setState({ SelectedSession: null });
    };
    Schedule.prototype.setSelectedSession = function (session) {
    ...
    Schedule.prototype.render = function () {
        ...
        if (this.state.Schedule != null) {
            var keys = Object.keys(this.state.Schedule);
            todaySchedule = this.state.Schedule[this.state.SelectedDate].rooms;
        }
        var lastStart = [];
        var timeOptions = {
        ...
        for (var i = 0; i < roomNames.length; i++) {
            ...
            var _loop_1 = function (i_1) {
                var s = sessions[i_1];
                if (lastStart.filter(function (x) { return x == s.startsAt; }).length == 0) {
                    lastStart.push(s.startsAt);
                    gridStyle.gridTemplateRows += " 150px";
                    //times.push(s.startsAt);
                }
            };
        ...
        return React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "EMGGrid", style: gridStyle },
                ...
                lastStart.map(function (t, idx) {
                    var startDate = dayjs(t);
                    return React.createElement("h2", { className: "gridItem timeItem", style: { gridColumn: "1/" + (roomNames.length + 1), gridRow: idx + 2 + "/" + (lastStart.length + 1) } }, startDate.format("hh:mm A"));
                }),
                (todaySchedule != null) ?
                    roomNames.map(function (r, ridx) {
                        var sessions = todaySchedule[r];
                        return React.createElement(React.Fragment, null,
                            React.createElement("span", { className: "gridItem sessionItem", style: { gridColumn: ridx + 2 + "/" + (roomNames.length + 1), gridRow: "1/" + (lastStart.length + 1) } },
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var ScheduleSession = /** @class */ (function (_super) {
    __extends(ScheduleSession, _super);
    function ScheduleSession() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ScheduleSession.prototype.render = function () {
        var _this = this;
        var sessionStart = new Date(this.props.Session.startsAt);
        var sessionEnd = new Date(this.props.Session.endsAt);
        //debugger;
...
exports.default = ScheduleSession;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var SessionModal = /** @class */ (function (_super) {
    __extends(SessionModal, _super);
    function SessionModal() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SessionModal.prototype.render = function () {
        var _this = this;
        ...
        return React.createElement("div", { className: showHideClassName, onClick: this.props.handleClose },
            React.createElement("section", { className: "modal-main", onClick: function (e) { e.stopPropagation(); } },
                ...
                React.createElement("span", { className: "sessionDescription" }, this.props.Session.description),
                React.createElement("span", { className: "sessionSpeakers" }, speakers.map(function (s) {
                    return React.createElement(React.Fragment, null,
...
var SessionizeService = /** @class */ (function () {
    function SessionizeService(embedURL) {
        this.embedURL = "";
        this.embedURL = embedURL;
    }
    SessionizeService.prototype.GetSpeakers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reqUrl, resp, speakers, i, speaker;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reqUrl = this.embedURL + "/view/Speakers";
    ...
    SessionizeService.prototype.GetSessions = function (fieldsToPromote) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reqUrl = this.embedURL + "/view/Sessions";
                        return [4 /*yield*/, axios_1.default.get(reqUrl)];
                    case 1:
                        resp = _a.sent();
                        debugger;
                        ...
                        return [2 /*return*/, sessions.sort(function (first, second) {
                                if (first.startAtLocal > second.startAtLocal) {
                                    return 1;
                                }
                                else if (first.startAtLocal < second.startAtLocal) {
                                    return -1;
                                }
                                else {
                                    return 0;
    ...
    SessionizeService.prototype.formatDate = function (dt, format) {
        var newDate = dayjs(dt);
        switch (format) {
            case "full":
    ...
    SessionizeService.prototype.GetSchedule = function (sessions) {
        return __awaiter(this, void 0, void 0, function () {
            var schedule, scheduleTmp, keys, idx, rooms;
            return __generator(this, function (_a) {
                schedule = {};
                scheduleTmp = sessions.reduce(function (groups, item) {
                    var val = item["sessionDate"];
                    groups[val] = groups[val] || [];
                    groups[val].push(item);
                    return groups;
                }, {});
                keys = Object.keys(scheduleTmp);
                for (idx = 0; idx < keys.length; idx++) {
                    rooms = scheduleTmp[keys[idx]].reduce(function (groups, item) {
                        var val = item["room"];
                        groups[val] = groups[val] || [];
                        groups[val].push(item);
                        return groups;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [2 /*return*/, [{
                                    "Sponsor": "all",
                                    "Content": "<img src='images/M365_California_Sponsors.png' />"
                                }]];
